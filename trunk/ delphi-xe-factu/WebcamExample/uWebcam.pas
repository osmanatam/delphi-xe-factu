...
var
  ...
  libhandle:cardinal;
  CapGetDriverDescriptionA: function(DrvIndex:cardinal; Name:PWideChar;NameLen:cardinal;Description:PWideChar;DescLen:cardinal):boolean; stdcall;
  CapCreateCaptureWindowA: function(lpszWindowName: PWideChar; dwStyle: dword; x, y, nWidth, nHeight: word; ParentWin: dword; nId: word): dword; stdcall;
